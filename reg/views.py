    ...
    if request.method == 'POST':
        ...
        if registration_password == registration_confirm_password:
            ...
            # Using User.objects.create_user user will be created is admin database
                ...
                registration_user = User.objects.create_user(username=registration_username, email=registration_email,
                                                             password=registration_password)
                registration_user.save()
                messages.success(request, 'You have Successfully Registered')
                send_mail("FakerRank", "You have Successfully Registered to FakerRank", "namratagaland@gmail.com",
                          [registration_email, ])
